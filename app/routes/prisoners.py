...
@router.patch("/{prisoner_id}", response_model=PrisonerGet)
...
@router.get("/{prisoner_id}", response_model=PrisonerGet)
...
@router.get("/", response_model=list[PrisonerGet])
